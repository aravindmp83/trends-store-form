...
// Initialize Supabase client using environment keys set in Vercel
        ...
        {!storeData ? (
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              <input 
                type="text" 
                className="border p-2 flex-grow rounded uppercase text-black"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {storeData.City?.toLowerCase() === 'chennai' && (
              <div className="mt-4 p-4 border border-blue-300 bg-blue-50 rounded">
                ...
                <select 
                  className="border p-2 w-full rounded text-black mb-4"
